...
class DataBasa:
    ...
    def add_game_chess(self, id_1, id_2, message_id, message_id_two, board):
        with self.connect:
            self.cursor.execute("INSERT INTO chess_game(id_1, id_2, message_id, message_id_two, board, time_id_1, time_id_2) VALUES(%s, %s, %s, %s, %s)", (id_1, id_2, message_id, message_id_two, board,))
            self.connect.commit()
